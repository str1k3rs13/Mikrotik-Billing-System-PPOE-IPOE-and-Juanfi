...
2. Open that folder. You should see `JeffNetPanel.exe` and some other files.

---

## STEP 3 — Start it
1. Double-click **`JeffNetPanel.exe`**.
...
## Daily use
- Just double-click **`JeffNetPanel.exe`** and open **http://localhost:3000**.
...
Make sure Node.js is installed (Step 1) and `JeffNetPanel.exe` is in the same folder as the
